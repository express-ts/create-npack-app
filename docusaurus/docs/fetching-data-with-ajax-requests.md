...
For example, support in Internet Explorer requires a [polyfill](https://github.com/express-ts/create-npack-app/blob/master/packages/react-app-polyfill/README.md).
