...
When running a production build of freshly created Create Npack App application, there are a number of `.js` files (called _chunks_) that are generated and placed in the `build/static/js` directory:
