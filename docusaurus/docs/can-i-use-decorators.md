...
Create Npack App intentionally doesn’t support decorator syntax at the moment because:
...
Create Npack App will add decorator support when the specification advances to a stable stage.
