...
This package includes the shareable ESLint configuration used by [Create Npack App](https://github.com/express-ts/create-npack-app).<br>
...
## Usage in Create Npack App Projects

The easiest way to use this configuration is with [Create Npack App](https://github.com/express-ts/create-npack-app), which includes it by default.

**You don’t need to install it separately in Create Npack App projects.**

## Usage Outside of Create Npack App

If you want to use this ESLint configuration in a project not built with Create Npack App, you can install it with the following steps.
...
However, if you are using [Create Npack App](https://github.com/express-ts/create-npack-app) and have not ejected, any additional rules will only be displayed in the [IDE integrations](https://facebook.github.io/create-npack-app/docs/setting-up-your-editor#displaying-lint-output-in-the-editor), but not in the browser or the terminal.
